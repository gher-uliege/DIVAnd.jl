...
@bind nobs  Slider(round.(Int,10. .^ (0:0.1:4)),default=1000)
...
md"Noise on observations \[°C\] (`noise` = $noise)"
...
md"Uncertainty of the observation \[adimensional\] (`epsilon2` = $epsilon2)"
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "3e4d1ab59f6e7abd4d49381315d59ab819200b77"
