...
# ╔═╡ d98078c4-489e-11ee-15ea-25656eb62f34
begin
	using DIVAnd
	using PlutoUI
	using Plots
...
# ╔═╡ f2112c8d-f068-42bf-a643-635232a1ac71
md"""
## Set parameter values
### Correlation length
"""

# ╔═╡ b6050a05-62ff-4c67-a581-64d2c17dfdc2
@bind len Slider(0.5:0.5:100, default=10)

# ╔═╡ bb892a4a-31cd-4a99-a8d6-63469389cd18
"Correlation length: $(len)" 

# ╔═╡ 1d64749c-be4a-40d4-b57a-b70abc00374d
md"""
### Noise-to-signal ratio
"""

# ╔═╡ 14750ab9-38d9-48cb-bd54-316ff420cba9
@bind epsilon2 NumberField(0.0001:1000, default=1.0)

# ╔═╡ 3088eef7-2da8-4b0e-a983-24a294e5d0a7
md"""
### Wall position
"""

# ╔═╡ 39c7cd77-0104-4029-84c0-521b00824c91
@bind wallx Slider(0:1:49)

# ╔═╡ fca75566-b2f6-47b3-ac1a-9806ab0986cf
begin
	mask = trues(size(xi));
	mask[:,1:wallx] .= false
	pp = Plots.heatmap(0:100,0:100, mask)
	scatter!(pp, x, y, label="observation")
end

# ╔═╡ 23b65b7c-81f6-4a51-9862-1d2ac5c3576f
md"""
## Run `DIVAnd` interpolation
"""

# ╔═╡ 2e6e7e13-da7f-4084-8cdc-a7d86dec7367
begin 
	fi, s = DIVAndrun(mask,(pm,pn),(xi,yi),(x,y),f,len,epsilon2;alphabc=2);
end;

# ╔═╡ 3cddf7a7-9245-4669-8e31-c390c1ab8e28
md"""
## Plot results
"""

# ╔═╡ 70eccb11-ccdb-4895-b6fa-4750817dcc12
begin
	contourf(fi; aspect_ratio=:equal)
end
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "e8c7e0624de25eef3009c3a9e30164a8d9d6d5df"
...
git-tree-sha1 = "69bf9799905b9f68faebecdeaa1d2fbbaea2746f"
