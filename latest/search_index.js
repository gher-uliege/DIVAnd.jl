...

{
    ...
    "category": "type",
    "text": "TS = TimeSelectorYearListMonthList(yearlists,monthlists)\n\nThe structure TS handels the time arregation base on yearlists and  monthlists. yearlists is vector of ranges  (containing start and end year),  for example [1980:1990,1990:2000,2000:2010].\n\nmonthlists is vector of two-element vector (containing start and end month), for  example [1:3,4:6,7:9,10:12]\n\nIf a month range spans beyond December, then all Months must be specified, e.g. example [2:4,5:6,7:9,[10,11,12,1]] or [2:4,5:6,7:9,[10:12;1]].  However using [2:4,5:6,7:9,10:1] (bug!) will result in an empty month range.\n\n\n\n"
},
...

{
    ...
    "title": "divand.stats",
    "category": "function",
    "text": "meanx,stdx = stats(sumx,sumx2,N)\n\nComputes the mean meanx and the standard deviation stdx from the sum (sumx) and the sum of squares (sumx2) from N numbers.\n\n\n\nmeanx,meany,stdx,stdy,covar,corr = stats(sumx,sumx2,sumy,sumy2,sumxy,N)\n\nComputes the mean meanx and the standard deviation stdx from the sum (sumx) and the sum of squares (sumx2) from N numbers and similarily for the variable y. The function computes also the Pearson correlation corr and covariance covar between x and y.\n\n\n\n"
},
